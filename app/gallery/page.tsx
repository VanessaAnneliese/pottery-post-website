...
export default function GalleryPage() {
  return (
    <>
    <QuoteBlock quote="Surround yourself with pottery and you surround yourself with the love of the people who made it." className="pt-24 md:pt-32 pb-12 md:pb-16" />
