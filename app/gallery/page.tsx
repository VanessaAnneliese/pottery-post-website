...
export default function GalleryPage() {
  return (
    <>
    <QuoteBlock quote={<>There is a quiet<br className="md:hidden" /> in beautiful pottery that settles something inside you.</>} className="pt-24 md:pt-32 pb-12 md:pb-16" />
