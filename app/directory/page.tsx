...
function DirectoryContent() {
  ...
  return (
    ...
    {selectedType === null && <QuoteBlock quote="Every name in this directory is a person who chose to make something with their hands. That choice deserves to be found." />}
