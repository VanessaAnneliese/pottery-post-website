        ...
        <div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              ...
              <p style={{ color: "#5C3D2E" }}>You can reach us at <a href="mailto:hello@potterypost.ca" className="underline" style={{ color: "#009999" }}>hello@potterypost.ca</a>. For directory questions specifically, use <a href="mailto:directory@potterypost.ca" className="underline" style={{ color: "#009999" }}>directory@potterypost.ca</a>.</p>
            </div>
            <div>
