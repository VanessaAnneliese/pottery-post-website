...
export default function PostmarksPage() {
  return (
    <>
      <QuoteBlock
        quote={<>The best pottery finds<br className="md:hidden" /> you when you&rsquo;re already somewhere beautiful.<br className="hidden md:block" /> Going looking is<br className="md:hidden" /> even better.</>}
